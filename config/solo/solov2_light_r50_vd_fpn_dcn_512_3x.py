...
class SOLOv2_light_r50_vd_fpn_dcn_512_3x_Config(object):
    def __init__(self):
        ...
        # AIStudio下的deepfashion2数据集
        # self.train_path = '../data/data112262/train/train.json'
        # self.val_path = '../data/data112262/validation/val.json'
        # self.classes_path = 'data/deepfashion2_classes.txt'
        # self.train_pre_path = '../data/data112262/train/image/'  # 训练集图片相对路径
        # self.val_pre_path = '../data/data112262/validation/image/'      # 验证集图片相对路径
        # self.num_classes = 13                                # 数据集类别数
